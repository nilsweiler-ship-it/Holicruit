    ...
    tiers: [
      {
        name: "Starter",
        price: "€0",
        blurb: "Hire your first role with transparency built in.",
        features: [
          "1 open role",
          "Basic pipeline",
      ...
      },
      {
        ...
        price: "€399",
        cadence: "/mo",
        blurb: "For high-volume hiring with full visibility.",
        features: [
        ...
        cta: { label: "Choose Scale", href: "/register?plan=hm-scale" },
      },
    ],
  },
  {
